...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const pointerMoveHandler = (e: PointerEvent) => handlePointerMove(e as any);
    const pointerEnterHandler = (e: PointerEvent) => handlePointerEnter(e as any);
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--avatar-bg': avatarUrl ? `url(${avatarUrl})` : 'none'
    } as React.CSSProperties),
    [iconUrl, grainUrl, innerGradient, behindGlowColor, behindGlowSize, avatarUrl]
  );
      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content pc-avatar-bg">
            </div>
